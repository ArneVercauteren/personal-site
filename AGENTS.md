# personal-site — AI working agreement

> **Read this every session.** Auto-loaded by Claude Code (`CLAUDE.md`) and Codex (`AGENTS.md`). Treat the contents as binding context.
