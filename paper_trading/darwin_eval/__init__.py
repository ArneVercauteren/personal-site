"""Vendored Astralanx DSL evaluator (scrubbed copy — Tier 2b).

This subpackage is a self-contained, scrubbed copy of Astralanx's pure-Python
...
It is a COPY, not an import: nothing here reaches into the Astralanx source tree,
and no secret (formula/weights of secured kings, `src/config/secrets.py`) lives
here. See docs/concepts/separation-from-darwin.md. Parity with Astralanx's own
